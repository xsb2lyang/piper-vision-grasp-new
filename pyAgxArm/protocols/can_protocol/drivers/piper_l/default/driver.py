...
class Driver(PiperDriverDefault):
   ...
   - `timeout == 0.0`: non-blocking; evaluate readiness once and return immediately.
   ...
   - Some `set_*` APIs additionally verify by reading back state; their docstrings
   will mention the verification method if applicable.
   """
   pass