...
class ArmMsgFeedbackCurrentMotorAngleLimitMaxSpd(AttributeBase):
    def __init__(self, 
    ...
    def clear(self):
        self.max_angle_limit = None
        self.min_angle_limit = None
        self.max_joint_spd = None    

class ArmMsgFeedbackAllCurrentMotorAngleLimitMaxSpd(AttributeBase):
    '''
    feedback
    ...
    def __init__(self, joint_index: Literal[0, 1, 2, 3, 4, 5, 6] = 0):
